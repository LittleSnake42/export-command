...
function wp_export_snake( $args = array() ) {
	$defaults     = array(
		'filters'     => array(),
		'format'      => 'WP_Export_WXR_Formatter_Snake',
		'writer'      => 'WP_Export_Returner_Snake',
		'writer_args' => null,
	);
	$args         = wp_parse_args( $args, $defaults );
	$export_query = new WP_Export_Query_Snake($args['filters'] );
